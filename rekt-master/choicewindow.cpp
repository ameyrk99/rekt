...
void ChoiceWindow::on_button_find_clicked() /*compiles user choices for generating random list of books that fit description*/
{
...
void ChoiceWindow::on_button_refresh_clicked() /*resets user values*/
{
...
void ChoiceWindow::on_button_userlist_clicked() /*displays user list and other options*/
{
...
void ChoiceWindow::on_deleteButton_clicked() /*removes book from user list*/
{
...
void::ChoiceWindow::on_info_button_clicked() /*displays information about book*/
{
...
void ChoiceWindow::user_list_buy_book(int idn) /*opens link to book*/
{
